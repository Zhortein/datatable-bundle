...
namespace Zhortein\AcmeDatatableTheme\Theme;
...
final readonly class AcmeTheme implements ThemeInterface
{
    ...
    public function __construct()
    {
        $this->metadata = new ThemeMetadata(
            name: 'acme',
            templatePrefix: '@AcmeDatatableTheme/bootstrap',
    ...
    public function getDefaultCellClassName(CellType $cellType): ?string
    {
        return match ($cellType) {
            CellType::Numeric => 'text-end align-middle acme-cell--numeric',
            CellType::Boolean, CellType::Enum => 'text-center align-middle acme-cell--centered',
            default => null,
        };
    }
}
